...
const INGREDIENT_GOOD: Record<string, string[]> = {
  oily: [
    "salicylic acid", "niacinamide", "hyaluronic acid", "zinc", "zinc pca",
    "tea tree", "melaleuca", "benzoyl peroxide", "clay", "kaolin", "bentonite",
    "witch hazel", "centella asiatica", "green tea", "camellia sinensis",
    "sodium hyaluronate", "glycolic acid", "lactic acid", "mandelic acid",
    "azelaic acid", "sulfur", "charcoal", "willow bark", "retinol",
    "panthenol", "allantoin", "aloe barbadensis",
  ],
  dry: [
    "ceramide", "ceramides", "ceramide np", "ceramide ap", "ceramide eop",
    "hyaluronic acid", "sodium hyaluronate", "squalane", "squalene",
    "shea butter", "butyrospermum parkii", "glycerin", "panthenol",
    "urea", "petrolatum", "dimethicone", "cyclomethicone",
    "jojoba oil", "simmondsia chinensis", "argan oil",
    "avocado oil", "persea gratissima", "sweet almond oil",
    "cholesterol", "phytosphingosine", "fatty acid",
    "lanolin", "colloidal oatmeal", "avena sativa",
    "allantoin", "propylene glycol", "sorbitol", "trehalose",
    "caprylic triglyceride", "cetearyl alcohol", "stearic acid",
    "tocopherol", "vitamin e", "rosehip oil", "marula oil",
  ],
  sensitive: [
    "centella", "centella asiatica", "madecassoside", "asiaticoside",
    "cica", "ceramide", "ceramides", "aloe", "aloe barbadensis",
    "oat", "avena sativa", "colloidal oatmeal", "allantoin",
    "bisabolol", "panthenol", "provitamin b5", "beta-glucan",
    "chamomile", "matricaria", "licorice", "glycyrrhiza glabra",
    "calendula", "green tea", "zinc oxide", "niacinamide",
    "squalane", "glycerin", "hyaluronic acid", "sodium hyaluronate",
    "shea butter", "phytosphingosine", "cholesterol",
  ],
  acne: [
    "salicylic acid", "benzoyl peroxide", "niacinamide", "retinol",
    "retinal", "retinaldehyde", "adapalene", "azelaic acid",
    "zinc", "zinc pca", "tea tree", "melaleuca alternifolia",
    "sulfur", "glycolic acid", "lactic acid", "mandelic acid",
    "willow bark", "centella asiatica", "bakuchiol",
    "bentonite", "kaolin", "charcoal", "witch hazel",
    "allantoin", "panthenol", "green tea", "resveratrol",
  ],
  hyperpigmentation: [
    "vitamin c", "ascorbic acid", "l-ascorbic acid", "ascorbyl glucoside",
    "ascorbyl tetraisopalmitate", "sodium ascorbyl phosphate",
    "3-o-ethyl ascorbic acid", "magnesium ascorbyl phosphate",
    "arbutin", "alpha arbutin", "beta arbutin",
    "niacinamide", "tranexamic acid", "kojic acid",
    "azelaic acid", "licorice", "glycyrrhiza glabra", "glabridin",
    "mulberry", "morus alba", "turmeric", "curcuma longa",
    "ferulic acid", "glutathione", "cysteamine",
    "hydroquinone", "resorcinol", "retinol", "retinoid",
    "phytic acid", "galactomyces", "rice bran", "oryza sativa",
  ],
  aging: [
    "retinol", "retinal", "retinaldehyde", "retinoid", "retinyl palmitate",
    "adapalene", "bakuchiol",
    "peptide", "peptides", "palmitoyl tripeptide", "matrixyl",
    "argireline", "acetyl hexapeptide", "copper peptide",
    "vitamin c", "ascorbic acid", "l-ascorbic acid", "ferulic acid",
    "hyaluronic acid", "sodium hyaluronate",
    "niacinamide", "coq10", "ubiquinone",
    "resveratrol", "polyphenol", "green tea", "egcg",
    "squalane", "ceramide", "collagen", "elastin",
    "glycolic acid", "lactic acid", "pha", "gluconolactone",
    "vitamin e", "tocopherol", "astaxanthin",
    "adenosine", "edelweiss", "stem cell",
  ],
};

const INGREDIENT_BAD: Record<string, string[]> = {
  oily: [
    "coconut oil", "cocos nucifera oil", "mineral oil", "paraffinum liquidum",
    "cocoa butter", "theobroma cacao", "isopropyl myristate",
    "isopropyl palmitate", "lanolin", "petrolatum",
    "wheat germ oil", "avocado oil", "sweet almond oil",
  ],
  dry: [
    "alcohol denat", "denatured alcohol", "sd alcohol", "isopropyl alcohol",
    "witch hazel", "menthol", "camphor", "eucalyptus",
    "sodium lauryl sulfate", "sls",
    "benzoyl peroxide", "salicylic acid",
  ],
  sensitive: [
    "fragrance", "parfum", "essential oil", "linalool", "limonene",
    "citronellol", "geraniol", "eugenol", "cinnamal",
    ...
    "propylene glycol", "witch hazel",
    "benzoic acid", "cinnamic acid", "sorbic acid",
  ],
  acne: [
    "coconut oil", "cocos nucifera oil", "isopropyl myristate",
    "isopropyl palmitate", "cocoa butter", "theobroma cacao",
    "algae extract", "laureth-4", "lauryl alcohol",
    "wheat germ oil", "lanolin", "acetylated lanolin alcohol",
    "myristyl myristate", "octyl stearate", "butyl stearate",
